...
# 微信公众号：网寻星
# 定时：一天一次
# https://raw.githubusercontent.com/JDWXX/ql_all/master/imt/imaotai.py
...
#   ToKen获取方式
#       1. 关注微信公众号 网寻星
#           i茅台获取验证码,1300000xxxx
#           i茅台登录,1300000xxxx,008449
#           i茅台查询账号信息,1300000xxxx
#           如需代挂
#           i茅台绑定,1300000xxxx,浙江省-杭州市 (选择你对应的省市)
#           i茅台执行日志,1300000xxxx （脚本每天9-10点执行，请在十点后查询日志）
#
#       2. 小黄鸟
